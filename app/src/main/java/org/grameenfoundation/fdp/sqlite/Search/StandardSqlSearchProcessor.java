 ...
 * A search processor that generates Standard SQL from the Search that are passed to the methods.
 */
public class StandardSqlSearchProcessor implements SearchProcessor {
    ...
    //Return an instance of the given class type that has the given value. For example,
    // if type is Long and Integer type with the value 13 is passed in, a new instance of Long
    // will be returned with the value 13. If the value is already of the correct type, it is
    // simply returned.
