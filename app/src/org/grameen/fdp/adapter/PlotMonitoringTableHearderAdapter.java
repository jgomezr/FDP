...
public class PlotMonitoringTableHearderAdapter extends TableHeaderAdapter {
    ...
    public PlotMonitoringTableHearderAdapter(Context context, String... headers) {
        super(context);
        this.headers = headers;
    }


    public PlotMonitoringTableHearderAdapter(Context context, int... headerStringResources) {
        super(context);
