...
public class SyncDownActivityBak extends SalesforceActivity {
    ...
    void downloadFarmerData() {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                progressDialog.setMessage("Downloading all farmers basic information data");
            }
        });


        String soql = "select id, name, Start__c, End__c from fpd_Submission__c where Surveyor__c = '" + USER_ID + "' ORDER BY Id DESC";
            ...
            if (restResponse.isSuccess()) {
                ...
                try {
                    ...
                    if (submissions.size() < 1)
                        showNoData();
                        //showDialog(getResources(R.string.no_farmers), getResources(R.string.no_old_data), false);
                    else {
                ...
                try {
                    ...
                    if (objects.size() > 0) {
                        ...
                        for (int i = 0; i < objects.size(); i++) {
                            Assignation assignation = (Assignation) objects.get(i);
                            ALL_ASSIGNATIONS_LIST.add(assignation.getExternal_id__c());
                        }
    ...
    void getAllFarmers() {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                progressDialog.setMessage("Getting all farmer data");
            }
        });


        String soql = "select id, External_id__c, fullName__c, Name, gender__c, village__c, birthday__c, educationalLevel__c from fdp_farmer_answer__c where Submission__c  = '" + SUBMISSION_ID + "'";
    ...
    void getAllPlots() {
        ...
        String soql = "select id, External_id__c, Farmer_code__c, Plot_area_coordinates__c, Plot_name__c, Recommendation_id__c, Start_year__c from fpd_Plot_answer__c where Submission__c  = '" + SUBMISSION_ID + "'";
    ...
    void getAllAnswers() {
        ...
        String soql = "select id, External_id__c, Answer__c, Date__c, Farmer_ID__c, Question__c from fpd_Answer__c where Submission__c  = '" + SUBMISSION_ID + "'";
    ...
    void getAllMonitoring() {
        ...
        String soql = "select id, External_id__c, MonitoringName__c, Plot_External_id__c, Result__c, Year__c from fdp_Monitoring__c where Submission__c  = '" + SUBMISSION_ID + "'";
    ...
    void getAllMonitoringAnswers() {
        ...
        String soql = "select id, External_id__c, Monitoring__c, Question__c, Answer__c, Competence__c, Competence_Answer__c, Reasons_For_Failure__c, Reasons_for_failure_answer__c from fdp_Monitoring_Answer__c where Submission__c  = '" + SUBMISSION_ID + "'";
    ...
    void showDialog(final String title, final String message, final boolean showRetry) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(SyncDownActivityBak.this, R.style.AppDialog);
