    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(plot != null){
            ...
            try {
                ...
                String limeNeededValue = AI_VALUES.get(prefs.getString("lime_needed_id", "")).toString();
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
              ...
              /*  try {
                ...
                if(PLOT_AO_JSON_OBJECT.length() >= databaseHelper.getSpecificSetOfQuestions(Constants.ADOPTION_OBSERVATIONS).size() + 3){
                ...
                if (PLOT_RECOMMENDATION == null)
                    ...
                    if (databaseHelper.editFarmerPlotRecommendationId(
                        ...
                        else recNames = GAPS_RECOMENDATION_FOR_START_YEAR.getName() + ", " + PLOT_RECOMMENDATION.getName();
